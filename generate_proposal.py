...
if __name__ == "__main__":
    ...
    model = SimpleYOLOWorldDetector(backbone_size=model_size, prompt_dim=768, num_prompts=256, num_proposals=args.num_proposals)
    ...
    if args.visualize:
        ...
        pred_image = plot_bounding_boxes(image, pred_bboxes.cpu().tolist())
